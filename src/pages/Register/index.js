...
const Register = () => {
    ...
    const handleClickCaptcha = () =>{
        form.validateFields(['username','email','password'])
            .then(() =>{
                console.log(form.getFieldValue(['username','email','password']))
                dispatch(getCaptcha(form.getFieldValue(['username','email','password'])))
        })
    }
            ...
            <div className={styles.register}>
                ...
                >
                    ...
                    <Row justify="space-between" align="middle">
                        <Col span = {8}>
                            <SubmitButton onClick={handleRegister}>注册</SubmitButton>
                        </Col>
                        <Col span = {16}>
