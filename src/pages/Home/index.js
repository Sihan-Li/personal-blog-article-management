...
import {HomeOutlined,ClusterOutLined,ContractsOutlined} from '@antd-design/icons';
...
const renderUserInfo = (currentUser) =>(
    <div className={styles.detail}>
        <p>
            <ContractsOutlined className={styles.userInfoIcon} />
            {currentUser.title}
        </p>
        <p>
